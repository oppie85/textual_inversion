...
class LatentDiffusion(DDPM):
    ...
    def log_images(self, batch, N=8, n_row=4, sample=True, ddim_steps=50, ddim_eta=1., return_keys=None,
        ...
        #oppie85: don't log the inputs or reconstructions = we know they work

        #log["inputs"] = x
        #log["reconstruction"] = xrec

        #oppie85: skip logging the unnecessary conditioning text images
        ...
        # remove unused plot_diffusion_rows:
        ...
        if sample:
            ...
            #oppie85: don't log the unscaled samples because they're useless
            ...
            sample_scaled, _ = self.sample_log(cond=c, 
                                               ...
                                               eta=ddim_eta,                                                 
                                               unconditional_guidance_scale=7.5, #oppie85: scaled samples logged at scale 7.5 as that's the default for most SD repos
                                               unconditional_conditioning=uc)
            log["samples_scaled"] = self.decode_first_stage(sample_scaled)

            #oppie85: painting test

            pc = self.get_learned_conditioning(["A painting of *","A pencil drawing of *"])
            pc_sample_scaled, _ = self.sample_log(cond=pc, 
                                               batch_size=N, 
                                               ddim=use_ddim, 
                                               ddim_steps=ddim_steps,
                                               eta=ddim_eta,                                                 
                                               ...
                                               unconditional_conditioning=uc)
            log["samples_scaled_painting"] = self.decode_first_stage(pc_sample_scaled)


            #oppie85: removed quantize_denoised
           
            #oppie85: removed inpaint
